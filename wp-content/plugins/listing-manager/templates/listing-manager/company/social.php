<?php $facebook = get_post_meta( get_the_ID(), LISTING_MANAGER_COMPANY_PREFIX . 'social_facebook', true ); ?>
<?php $twitter = get_post_meta( get_the_ID(), LISTING_MANAGER_COMPANY_PREFIX . 'social_twitter', true ); ?>
<?php $linkedin = get_post_meta( get_the_ID(), LISTING_MANAGER_COMPANY_PREFIX . 'social_linkedin', true ); ?>
<?php $google = get_post_meta( get_the_ID(), LISTING_MANAGER_COMPANY_PREFIX . 'social_google', true ); ?>

<?php if ( ! empty( $facebook ) || ! empty( $twitter ) || ! empty( $linkedin ) || ! empty( $google ) ) : ?>
    <div class="post-social-simple">
        <ul>            
