...
<?php $shortcode_layout = ! empty( $instance['layout'] ) ? 'layout="' . $instance['layout'] . '"' : ''; ?>
...
<?php $shortcode = "[listing_manager_tiles $shortcode_layout $shortcode_category $shortcode_location]"; ?>
