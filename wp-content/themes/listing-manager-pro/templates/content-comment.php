    ...
    <div class="comment-wrapper">
        ...
        <div class="comment-inner">
            <div class="comment-header">
                ...
                <div class="comment-header-meta">
                    ...
                    <?php comment_reply_link( array_merge( $args, [
    					'add_below'     => 'comment',
    					'depth'         => $depth,
    					'reply_text'    => esc_html__( 'Reply', 'listing-manager-pro' ),
            ...
            <?php if ( '0' == $comment->comment_approved ) : ?>
                <em class="comment-awaiting-moderation"><?php echo esc_attr__( 'Your comment is awaiting moderation.', 'listing-manager-pro' ); ?></em>
                <br />
            <?php endif; ?>
        </div><!-- /.comment-content -->
    </div><!-- /.comment -->
